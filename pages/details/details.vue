<template>
	<view class="content">
		...
		<view class="example-body">
			<uni-nav-bar left-icon="arrowleft" right-text="" left-text="" title="订单详情" @clickLeft="back" />
		</view>
		<!-- ----------------------------------------------------------地图 --------------------------------------- -->
		<view class="map">
			<!-- <map></map> -->
			<image src="../../static/images/map_02.png" mode="widthFix"></image>
		</view>
...
<style>
	...
	.details .requirement .top .left-l text {
		font-size: 34rpx;
		font-weight: normal;
	}
